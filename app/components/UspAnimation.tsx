    ...
    <>
      <div className=" w-full pt-10 px-[3%]  md:hidden">
        <div className="w-full flex items-end p-3 overflow-hidden relative rounded-3xl ">
          ...
          />
          <div className="flex p-1 rounded-xl mt-110  bg-[#FFFEFA] relative w-full h-fit  gap-0">
            <div className=" aspect-[1/2.8] rounded-xl shrink-0  w-[30%] overflow-hidden ">
              <Image
                src={sticks}
                alt={`USP Sticks`}
            ...
            <motion.div
              className={`flex justify-between w-full p-3  flex-col ${playfairDisplay.className}`}
            >
      ...
      <div
        ref={containerRef}
        className=" bg-white md:block hidden   w-full h-[360vh]"
      >
